...
namespace Huobi.Net.Interfaces
{
    public interface IHuobiClient
    {
        ...
        /// <param name="limit">The max number of results</param>
        /// <returns></returns>
        WebCallResult<List<HuobiOrder>> GetOrders(IEnumerable<HuobiOrderState> states, string symbol = null, IEnumerable<HuobiOrderType> types = null, DateTime? startTime = null, DateTime? endTime = null, long? fromId = null, int? limit = null);
        ...
        /// <param name="limit">The max number of results</param>
        /// <returns></returns>
        Task<WebCallResult<List<HuobiOrder>>> GetOrdersAsync(IEnumerable<HuobiOrderState> states, string symbol = null, IEnumerable<HuobiOrderType> types = null, DateTime? startTime = null, DateTime? endTime = null, long? fromId = null, int? limit = null);
